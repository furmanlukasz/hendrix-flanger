...
static const FactoryPreset factoryPresets[] =
{
    ...
    { "Bold as Love",       0.18f, 85.0f, 4.5f, -60.0f, 120.0f, true,  0.0f, 0, 15.0f, 55.0f },

    // "Voodoo Child" — faster rate, moderate depth, positive feedback
    { "Voodoo Child",       0.8f,  65.0f, 3.5f,  55.0f,  90.0f, true,  0.0f, 0,  0.0f, 60.0f },

    // "Electric Ladyland" — extreme TZF with envelope follower
    { "Electric Ladyland",  0.4f,  90.0f, 5.0f,  40.0f, 150.0f, true, 70.0f, 0, 25.0f, 65.0f },

    // "Tape Machine" — subtle slow sweep, low feedback
    { "Tape Machine",       0.12f, 35.0f, 2.5f,  20.0f,  60.0f, false, 0.0f, 1, 40.0f, 45.0f },

    // "Jet Engine" — max depth TZF, high feedback, fast rate
    { "Jet Engine",         3.5f, 100.0f, 6.0f,  85.0f, 180.0f, true,  0.0f, 0,  0.0f, 75.0f },
